...
export const projects = [
  ...
  {id:'05',name:'DEVPATH',type:'AI / DEVELOPER LEARNING',description:'Less collecting tabs. More building things.',detail:'A developer resource explorer that turns learning goals into four-week study plans. Built with Next.js and TypeScript, it combines 15 curated resources with free OpenRouter AI, validated recommendations, template fallbacks, local progress tracking and Netlify API rate limiting.',tags:['Next.js','TypeScript','OpenRouter','AI'],kind:'learning',live:'https://devpath-vineetsaini.netlify.app',source:'https://github.com/vineetsaini007/devpath'},
];
...
export const featuredCopy: Record<string, {heading: [string,string]; description: string; caption: string; label: string; tags: string[]}> = {
  ...
  '05': {heading:['STAY CURIOUS.','KEEP BUILDING.'],description:'DevPath turns curated developer resources into a clear, personal four-week learning journey with AI assistance and saved progress.',caption:'YOUR NEXT SKILL STARTS HERE',label:'AI_LEARNING_SYSTEM',tags:['Free AI integration','Personal learning paths']},
};
